/**
 * CAN module object for NXP K64F microcontroller, using Kinetis SDK V2.
 *
 * @file        CO_driver.h
 * @ingroup     CO_driver
 ...
 * @copyright 	2017-2018 Matthew Watson
 *
 ...
 * @{
 */
    #define CO_LOCK_CAN_SEND()  	portDISABLE_INTERRUPTS()/**< Lock critical section in CO_CANsend() */
    #define CO_UNLOCK_CAN_SEND() 	portENABLE_INTERRUPTS()/**< Unlock critical section in CO_CANsend() */

    #define CO_LOCK_EMCY()      	portDISABLE_INTERRUPTS()/**< Lock critical section in CO_errorReport() or CO_errorReset() */
    #define CO_UNLOCK_EMCY()    	portENABLE_INTERRUPTS()/**< Unlock critical section in CO_errorReport() or CO_errorReset() */

    #define CO_LOCK_OD()        	portDISABLE_INTERRUPTS()/**< Lock critical section when accessing Object Dictionary */
    #define CO_UNLOCK_OD()      	portENABLE_INTERRUPTS()/**< Unock critical section when accessing Object Dictionary */
/** @} */
