...
component/led/%.o: ../component/led/%.c component/led/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-component-2f-led

clean-component-2f-led:
	-$(RM) ./component/led/led.d ./component/led/led.o

.PHONY: clean-component-2f-led
